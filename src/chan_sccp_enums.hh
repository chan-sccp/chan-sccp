...
BEGIN_ENUM(sccp,channelstate,ENUMMACRO_SPARSE)
        ...
        ENUM_ELEMENT(SCCP_CHANNELSTATE_CALLWAITING 			,= 33,	"CALLWAITING")
        ENUM_ELEMENT(SCCP_CHANNELSTATE_CALLPARK 			,= 34,	"CALLPARK")
        ENUM_ELEMENT(SCCP_CHANNELSTATE_CALLREMOTEMULTILINE 		,= 35,	"CALLREMOTEMULTILINE")
        ENUM_ELEMENT(SCCP_CHANNELSTATE_CALLCONFERENCE	 		,= 36,	"CALLCONFERENCE")
        ENUM_ELEMENT(SCCP_CHANNELSTATE_CALLTRANSFER 			,= 37,	"CALLTRANSFER")
        ENUM_ELEMENT(SCCP_CHANNELSTATE_BLINDTRANSFER 			,= 38,	"BLINDTRANSFER")
