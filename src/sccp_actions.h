...
SCCP_API void SCCP_CALL sccp_handle_backspace(constLineDevicePtr ld, const uint32_t callid)				__NONNULL(1);
SCCP_API void SCCP_CALL sccp_handle_dialtone(constLineDevicePtr ld, constChannelPtr channel)				__NONNULL(1,2);
