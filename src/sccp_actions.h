...
void sccp_handle_unknown_message(sccp_session_t * s, sccp_device_t * d, sccp_msg_t * msg_in);
void sccp_handle_dialedphonebook_message(sccp_session_t * s, sccp_device_t * d, sccp_msg_t * msg_in);
void sccp_handle_alarm(sccp_session_t * s, sccp_device_t * d, sccp_msg_t * msg_in);
void sccp_handle_token_request(sccp_session_t * s, sccp_device_t * d, sccp_msg_t * msg_in);
void sccp_handle_register(sccp_session_t * s, sccp_device_t * d, sccp_msg_t * msg_in);
void sccp_handle_SPCPTokenReq(sccp_session_t * s, sccp_device_t * d, sccp_msg_t * msg_in);
...
void sccp_handle_XMLAlarmMessage(sccp_session_t * s, sccp_device_t * d, sccp_msg_t * msg_in);
