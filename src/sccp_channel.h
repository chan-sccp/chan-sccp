...
#define sccp_channel_refreplace(_x, _y)	({sccp_channel_t const *tmp_##__LINE__##X = _x;ast_assert(tmp_##__LINE__##X != NULL);sccp_refcount_replace((void **)&_x, _y, __FILE__, __LINE__, __PRETTY_FUNCTION__);})
#else
