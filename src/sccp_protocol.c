...
const struct messagetype sccp_messagetypes[] = {
	...
	[OffHookMessageWithCallingPartyMessage] = {OffHookMessageWithCallingPartyMessage,"Off-Hook With Cgpn Message",			offsize(sccp_data_t, OffHookMessageWithCallingPartyMessage)},
