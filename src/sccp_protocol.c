...
/* done - registerACK */
static boolean_t sccp_protocol_retrieveTokenReqSCCP(const sccp_moo_t * r, sccp_device_t *device, uint32_t server_instance) {
	return TRUE;	
}
...
static boolean_t sccp_protocol_retrieveTokenReqSPCP(const sccp_moo_t * r, sccp_device_t *device, uint32_t server_instance) {
	return TRUE;	
}
