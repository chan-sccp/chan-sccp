...
/* prototypes */
void handle_unknown_message(constSessionPtr s, devicePtr d, constMessagePtr msg_in)		/* __attribute__((nonnull(1,2,3))) */;
void handle_dialedphonebook_message(constSessionPtr s, devicePtr d, constMessagePtr msg_in)	/* __attribute__((nonnull(1,2,3))) */;
void handle_alarm(constSessionPtr s, devicePtr d, constMessagePtr msg_in)				/* __attribute__((nonnull(1,3))) */;
void handle_token_request(constSessionPtr s, devicePtr d, constMessagePtr msg_in)			/* __attribute__((nonnull(1,3))) */;
void handle_register(constSessionPtr s, devicePtr d, constMessagePtr msg_in)			/* __attribute__((nonnull(1,3))) */;
void handle_SPCPTokenReq(constSessionPtr s, devicePtr d, constMessagePtr msg_in)			/* __attribute__((nonnull(1,3))) */;
void handle_accessorystatus_message(constSessionPtr s, devicePtr d, constMessagePtr msg_in)	/* __attribute__((nonnull(1,2,3))) */;
void handle_unregister(constSessionPtr s, devicePtr d, constMessagePtr msg_in)			/* __attribute__((nonnull(1,3))) */;
void handle_line_number(constSessionPtr s, devicePtr d, constMessagePtr msg_in)			/* __attribute__((nonnull(1,2,3))) */;
void handle_speed_dial_stat_req(constSessionPtr s, devicePtr d, constMessagePtr msg_in)		/* __attribute__((nonnull(1,2,3))) */;
void handle_stimulus(constSessionPtr s, devicePtr d, constMessagePtr msg_in)			/* __attribute__((nonnull(1,2,3))) */;
void handle_KeepAliveMessage(constSessionPtr s, devicePtr d, constMessagePtr msg_in) 		/* __attribute__((nonnull(1))) */;
void handle_offhook(constSessionPtr s, devicePtr d, constMessagePtr msg_in)			/* __attribute__((nonnull(1,2,3))) */;
void handle_onhook(constSessionPtr s, devicePtr d, constMessagePtr msg_in)				/* __attribute__((nonnull(1,2,3))) */;
void handle_headset(constSessionPtr s, devicePtr d, constMessagePtr msg_in)			/* __attribute__((nonnull(1,2,3))) */;
void handle_capabilities_res(constSessionPtr s, devicePtr d, constMessagePtr msg_in)		/* __attribute__((nonnull(1,2,3))) */;
void handle_soft_key_set_req(constSessionPtr s, devicePtr d, constMessagePtr msg_in)		/* __attribute__((nonnull(1,2,3))) */;
void handle_keypad_button(constSessionPtr s, devicePtr d, constMessagePtr msg_in)			/* __attribute__((nonnull(1,2,3))) */;
void handle_soft_key_event(constSessionPtr s, devicePtr d, constMessagePtr msg_in) 		/* __attribute__((nonnull(1,2,3))) */;
void handle_port_response(constSessionPtr s, devicePtr d, constMessagePtr msg_in)			/* __attribute__((nonnull(1,2,3))) */;
void handle_open_receive_channel_ack(constSessionPtr s, devicePtr d, constMessagePtr msg_in)	/* __attribute__((nonnull(1,2,3))) */;
void handle_OpenMultiMediaReceiveAck(constSessionPtr s, devicePtr d, constMessagePtr msg_in)	/* __attribute__((nonnull(1,2,3))) */;
void handle_ConnectionStatistics(constSessionPtr s, devicePtr d, constMessagePtr msg_in)		/* __attribute__((nonnull(1,2,3))) */;
void handle_version(constSessionPtr s, devicePtr d, constMessagePtr msg_in)			/* __attribute__((nonnull(1,2,3))) */;
void handle_ServerResMessage(constSessionPtr s, devicePtr d, constMessagePtr msg_in)		/* __attribute__((nonnull(1,2,3))) */;
void handle_ConfigStatMessage(constSessionPtr s, devicePtr d, constMessagePtr msg_in)		/* __attribute__((nonnull(1,2,3))) */;
void handle_EnblocCallMessage(constSessionPtr s, devicePtr d, constMessagePtr msg_in)		/* __attribute__((nonnull(1,2,3))) */;
void handle_forward_stat_req(constSessionPtr s, devicePtr d, constMessagePtr msg_in)		/* __attribute__((nonnull(1,2,3))) */;
void handle_feature_stat_req(constSessionPtr s, devicePtr d, constMessagePtr msg_in)		/* __attribute__((nonnull(1,2,3))) */;
void handle_services_stat_req(constSessionPtr s, devicePtr d, constMessagePtr msg_in)		/* __attribute__((nonnull(1,2,3))) */;
void handle_updatecapabilities_message(constSessionPtr s, devicePtr d, constMessagePtr msg_in)	/* __attribute__((nonnull(1,2,3))) */;
void handle_updatecapabilities_V2_message(constSessionPtr s, devicePtr d, constMessagePtr msg_in)	/* __attribute__((nonnull(1,2,3))) */;
void handle_updatecapabilities_V3_message(constSessionPtr s, devicePtr d, constMessagePtr msg_in)	/* __attribute__((nonnull(1,2,3))) */;
void handle_startmediatransmission_ack(constSessionPtr s, devicePtr d, constMessagePtr msg_in)	/* __attribute__((nonnull(1,2,3))) */;
void handle_device_to_user(constSessionPtr s, devicePtr d, constMessagePtr msg_in)			/* __attribute__((nonnull(1,2,3))) */;
void handle_device_to_user_response(constSessionPtr s, devicePtr d, constMessagePtr msg_in)	/* __attribute__((nonnull(1,2,3))) */;
void handle_XMLAlarmMessage(constSessionPtr s, devicePtr d, constMessagePtr msg_in)		/* __attribute__((nonnull(1,3))) */;
void handle_LocationInfoMessage(constSessionPtr s, devicePtr d, constMessagePtr msg_in)		/* __attribute__((nonnull(1,3))) */;
void handle_startmultimediatransmission_ack(constSessionPtr s, devicePtr d, constMessagePtr msg_in)/* __attribute__((nonnull(1,2,3))) */;
void handle_mediatransmissionfailure(constSessionPtr s, devicePtr d, constMessagePtr msg_in)	/* __attribute__((nonnull(1,2,3))) */;
void handle_miscellaneousCommandMessage(constSessionPtr s, devicePtr d, constMessagePtr msg_in)	/* __attribute__((nonnull(1,2,3))) */;
