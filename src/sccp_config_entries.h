...
static const SCCPConfigOption sccpGlobalConfigOptions[]={
	{"servername", 			G_OBJ_REF(servername), 			SCCP_CONFIG_DATATYPE_STRING,	SCCP_CONFIG_FLAG_REQUIRED,					SCCP_CONFIG_NOUPDATENEEDED,		"Asterisk",		NULL,					"show this name on the device registration\n"},
	{"keepalive", 			G_OBJ_REF(keepalive), 			SCCP_CONFIG_DATATYPE_INT,	SCCP_CONFIG_FLAG_REQUIRED,					SCCP_CONFIG_NEEDDEVICERESET,		"60",			NULL,					"Phone keep alive message every 60 secs. Used to check the voicemail and keep an open connection between server and phone (nat). \n"
																									  										"Don't set any lower than 60 seconds.\n"},
	{"debug", 			G_OBJ_REF(debug), 			SCCP_CONFIG_DATATYPE_GENERIC,	SCCP_CONFIG_FLAG_NONE | SCCP_CONFIG_FLAG_MULTI_ENTRY,		SCCP_CONFIG_NOUPDATENEEDED,		"core",			sccp_config_parse_debug,		"console debug level or categories\n"
	...
	{"context", 			G_OBJ_REF(context), 			SCCP_CONFIG_DATATYPE_STRING,	SCCP_CONFIG_FLAG_REQUIRED,					SCCP_CONFIG_NEEDDEVICERESET,		"sccp",			sccp_config_parse_context,		"pbx dialplan context\n"},
	...
	{"bindaddr", 			G_OBJ_REF(bindaddr), 			SCCP_CONFIG_DATATYPE_GENERIC,	SCCP_CONFIG_FLAG_REQUIRED,					SCCP_CONFIG_NEEDDEVICERESET,		"0.0.0.0",		sccp_config_parse_ipaddress,		"replace with the ip address of the asterisk server (RTP important param)\n"}, 
	...
	{"disallow", 			G_OBJ_REF(global_preferences),		SCCP_CONFIG_DATATYPE_GENERIC,	SCCP_CONFIG_FLAG_REQUIRED | SCCP_CONFIG_FLAG_MULTI_ENTRY,	SCCP_CONFIG_NEEDDEVICERESET,		"",			sccp_config_parse_disallow_codec,	"First disallow all codecs, for example 'all'\n"},
	{"allow", 			G_OBJ_REF(global_preferences),		SCCP_CONFIG_DATATYPE_GENERIC,	SCCP_CONFIG_FLAG_REQUIRED | SCCP_CONFIG_FLAG_MULTI_ENTRY,	SCCP_CONFIG_NEEDDEVICERESET,		"",			sccp_config_parse_allow_codec,		"Allow codecs in order of preference (Multiple lines allowed)\n"},
	{"deny", 			G_OBJ_REF(ha),	 			SCCP_CONFIG_DATATYPE_GENERIC,	SCCP_CONFIG_FLAG_REQUIRED | SCCP_CONFIG_FLAG_MULTI_ENTRY,	SCCP_CONFIG_NEEDDEVICERESET,		"0.0.0.0/0.0.0.0",	sccp_config_parse_deny,			"Deny every address except for the only one allowed. example: '0.0.0.0/0.0.0.0'\n"},
	{"permit", 			G_OBJ_REF(ha), 				SCCP_CONFIG_DATATYPE_GENERIC,	SCCP_CONFIG_FLAG_REQUIRED | SCCP_CONFIG_FLAG_MULTI_ENTRY,	SCCP_CONFIG_NEEDDEVICERESET,		"internal",		sccp_config_parse_permit,		"Accept class C 192.168.1.0 example '192.168.1.0/255.255.255.0'\n"
	...
	{"quality_over_size",		G_OBJ_REF(prefer_quality_over_size),	SCCP_CONFIG_DATATYPE_BOOLEAN,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		"yes",			NULL,					"When making decisions during codec selections prefer sound quality over packet size (default true)\n"},
	{"localnet", 			G_OBJ_REF(localaddr), 			SCCP_CONFIG_DATATYPE_GENERIC,	SCCP_CONFIG_FLAG_NONE | SCCP_CONFIG_FLAG_MULTI_ENTRY,		SCCP_CONFIG_NEEDDEVICERESET,		" ",			sccp_config_parse_permit,		"All RFC 1918 addresses are local networks, example '192.168.1.0/255.255.255.0'\n"},
	{"externip", 			G_OBJ_REF(externip), 			SCCP_CONFIG_DATATYPE_GENERIC,	SCCP_CONFIG_FLAG_NONE | SCCP_CONFIG_FLAG_MULTI_ENTRY,		SCCP_CONFIG_NEEDDEVICERESET,		"",			sccp_config_parse_ipaddress,		"IP Address that we're going to notify in RTP media stream\n"},
	...
	{"recorddigittimeoutchar", 	G_OBJ_REF(recorddigittimeoutchar), 	SCCP_CONFIG_DATATYPE_BOOLEAN,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		"no",		NULL,					"You can force the channel to dial with this char in the dialing state\n"},
	{"simulate_enbloc",	 	G_OBJ_REF(simulate_enbloc), 		SCCP_CONFIG_DATATYPE_BOOLEAN,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		"yes",			NULL,					"Use simulated enbloc dialing to speedup connection when dialing while onhook (older phones)\n"},
	...
	{"callevents", 			G_OBJ_REF(callevents), 			SCCP_CONFIG_DATATYPE_BOOLEAN,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		"yes",			NULL,					"Generate manager events when phone \n"
	...
	{"echocancel", 			G_OBJ_REF(echocancel), 			SCCP_CONFIG_DATATYPE_BOOLEAN,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		"yes",			NULL,					"sets the phone echocancel for all devices\n"},
	{"silencesuppression", 		G_OBJ_REF(silencesuppression), 		SCCP_CONFIG_DATATYPE_BOOLEAN,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		"no",			NULL,					"sets the silence suppression for all devices\n"
																																			"we don't have to trust the phone ip address, but the ip address of the connection\n"},
	{"trustphoneip", 		G_OBJ_REF(trustphoneip), 		SCCP_CONFIG_DATATYPE_BOOLEAN,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		"yes",			NULL,					"The phone has a ip address. It could be private, so if the phone is behind NAT \n"},
	...
	{"private", 			G_OBJ_REF(privacy), 			SCCP_CONFIG_DATATYPE_BOOLEAN,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		"yes",			NULL,					"permit the private function softkey\n"},
	{"mwilamp", 			G_OBJ_REF(mwilamp), 			SCCP_CONFIG_DATATYPE_GENERIC,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		"yes",			sccp_config_parse_mwilamp,		"Set the MWI lamp style when MWI active to on, off, wink, flash or blink\n"},
	{"mwioncall", 			G_OBJ_REF(mwioncall), 			SCCP_CONFIG_DATATYPE_BOOLEAN,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		"no",			NULL,					"Set the MWI on call.\n"},
	...
	{"cfwdall", 			G_OBJ_REF(cfwdall), 			SCCP_CONFIG_DATATYPE_BOOLEAN,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NEEDDEVICERESET,		"yes",			NULL,					"activate the callforward ALL stuff and softkeys\n"},
	{"cfwdbusy", 			G_OBJ_REF(cfwdbusy), 			SCCP_CONFIG_DATATYPE_BOOLEAN,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NEEDDEVICERESET,		"yes",			NULL,					"activate the callforward BUSY stuff and softkeys\n"},
	{"cfwdnoanswer", 		G_OBJ_REF(cfwdnoanswer), 		SCCP_CONFIG_DATATYPE_BOOLEAN,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NEEDDEVICERESET,		"yes",			NULL,					"activate the callforward NOANSWER stuff and softkeys\n"},
	{"nat", 			G_OBJ_REF(nat), 			SCCP_CONFIG_DATATYPE_BOOLEAN,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NEEDDEVICERESET,		"no",			NULL,					"Global NAT support (default Off)\n"},
	{"directrtp", 			G_OBJ_REF(directrtp), 			SCCP_CONFIG_DATATYPE_BOOLEAN,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		"no",			NULL,					"This option allow devices to do direct RTP sessions (default Off)\n"},
	{"allowoverlap", 		G_OBJ_REF(useoverlap), 			SCCP_CONFIG_DATATYPE_BOOLEAN,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		"no",			NULL,					"Enable overlap dialing support. If enabled, starts dialing immediately and sends remaing digits as DTMF/inband.\n"
	...
	{"regcontext", 			G_OBJ_REF(regcontext), 			SCCP_CONFIG_DATATYPE_STRING,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NEEDDEVICERESET,		"sccpregistration",	NULL,					"SCCP Lines will we added to this context in asterisk for Dundi lookup purposes. \n"
...
#endif
	{"meetme", 			G_OBJ_REF(meetme), 			SCCP_CONFIG_DATATYPE_BOOLEAN,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		"yes",			NULL,					"enable/disable conferencing via meetme (on/off), make sure you have one of the meetme apps mentioned below activated in module.conf\n"
	...
	{"jbenable", 			G_OBJ_REF(global_jbconf),	 	SCCP_CONFIG_DATATYPE_GENERIC,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		"yes",			sccp_config_parse_jbflags_enable,	" Enables the use of a jitterbuffer on the receiving side of a\n"
	...
	{"jbforce", 			G_OBJ_REF(global_jbconf),		SCCP_CONFIG_DATATYPE_GENERIC,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		"yes",			sccp_config_parse_jbflags_force,	"Forces the use of a jitterbuffer on the receive side of a sccp\n"
																																			"channel. Defaults to 'no'.\n"},
	{"jblog", 			G_OBJ_REF(global_jbconf),		SCCP_CONFIG_DATATYPE_GENERIC,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		"yes",			sccp_config_parse_jbflags_log,		" Enables jitterbuffer frame logging. Defaults to 'no'.\n"},
	{"jbmaxsize", 			G_OBJ_REF(global_jbconf.max_size),	SCCP_CONFIG_DATATYPE_INT,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		"200",			NULL,					"Max length of the jitterbuffer in milliseconds.\n"},
	{"jbresyncthreshold", 		G_OBJ_REF(global_jbconf.resync_threshold),SCCP_CONFIG_DATATYPE_INT,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		"1000",			NULL,					"Jump in the frame timestamps over which the jitterbuffer is\n"
																																			"resynchronized. Useful to improve the quality of the voice, with\n"
																																			"big jumps in/broken timestamps, usually sent from exotic devices\n"
																																			"and programs. Defaults to 1000.\n"},
	{"jbimpl", 			G_OBJ_REF(global_jbconf.impl),		SCCP_CONFIG_DATATYPE_STRING,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		"fixed",		NULL,					"Jitterbuffer implementation, used on the receiving side of a\n"
																																			"sccp channel. Two implementations are currently available\n"
																																			"- 'fixed' (with size always equals to jbmaxsize)\n"
																																			"- 'adaptive' (with variable size, actually the new jb of IAX2).\n"
																																			"Defaults to fixed.\n"},
	{"hotline_enabled", 		G_OBJ_REF(allowAnonymous), 		SCCP_CONFIG_DATATYPE_BOOLEAN,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		"yes",			NULL,					" Setting the hotline Feature on a device, will make it connect to a predefined extension as soon as the Receiver\n"
	...
	{"fallback",			G_OBJ_REF(token_fallback),		SCCP_CONFIG_DATATYPE_STRING,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		"no",		NULL, 					"Immediately fallback to primairy/master server when it becomes available (master/slave asterisk cluster) (TokenRequest)\n"
...
static const SCCPConfigOption sccpDeviceConfigOptions[] = {
	...
	{"device", 			D_OBJ_REF(config_type),			SCCP_CONFIG_DATATYPE_STRING,	SCCP_CONFIG_FLAG_REQUIRED,					SCCP_CONFIG_NEEDDEVICERESET,		NULL,			NULL, 					"device type\n"},
	{"devicetype", 			D_OBJ_REF(config_type),			SCCP_CONFIG_DATATYPE_STRING,	SCCP_CONFIG_FLAG_REQUIRED,					SCCP_CONFIG_NEEDDEVICERESET,		NULL,			NULL, 					"device type\n"},
	{"type", 			D_OBJ_REF(config_type),			SCCP_CONFIG_DATATYPE_STRING,	SCCP_CONFIG_FLAG_REQUIRED,					SCCP_CONFIG_NEEDDEVICERESET,		NULL,			NULL, 					"used for device templates, value will be inherited.\n"},
	...
	{"disallow", 			D_OBJ_REF(preferences), 		SCCP_CONFIG_DATATYPE_GENERIC,	SCCP_CONFIG_FLAG_GET_GLOBAL_DEFAULT | SCCP_CONFIG_FLAG_MULTI_ENTRY,	SCCP_CONFIG_NOUPDATENEEDED,		NULL,			sccp_config_parse_disallow_codec,	""},
	{"allow", 			D_OBJ_REF(preferences), 		SCCP_CONFIG_DATATYPE_GENERIC,	SCCP_CONFIG_FLAG_GET_GLOBAL_DEFAULT | SCCP_CONFIG_FLAG_MULTI_ENTRY,	SCCP_CONFIG_NOUPDATENEEDED,		NULL,			sccp_config_parse_allow_codec,		""},
	{"transfer", 			D_OBJ_REF(transfer),			SCCP_CONFIG_DATATYPE_BOOLEAN,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		"yes",			NULL, 					"enable or disable the transfer capability. It does remove the transfer softkey\n"},
	{"park", 			D_OBJ_REF(park),			SCCP_CONFIG_DATATYPE_BOOLEAN,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		"yes",			NULL, 					"take a look to the compile how-to. Park stuff is not compiled by default\n"},
	{"cfwdall", 			D_OBJ_REF(cfwdall), 			SCCP_CONFIG_DATATYPE_BOOLEAN,	SCCP_CONFIG_FLAG_GET_GLOBAL_DEFAULT,				SCCP_CONFIG_NOUPDATENEEDED,		"no",			NULL, 					"activate the call forward stuff and soft keys\n"},
	{"cfwdbusy", 			D_OBJ_REF(cfwdbusy), 			SCCP_CONFIG_DATATYPE_BOOLEAN,	SCCP_CONFIG_FLAG_GET_GLOBAL_DEFAULT,				SCCP_CONFIG_NOUPDATENEEDED,		"no",			NULL, 					"allow call forward when line is busy\n"},
	{"cfwdnoanswer", 		D_OBJ_REF(cfwdnoanswer),		SCCP_CONFIG_DATATYPE_BOOLEAN,	SCCP_CONFIG_FLAG_GET_GLOBAL_DEFAULT,				SCCP_CONFIG_NOUPDATENEEDED,		"no",			NULL, 					"allow call forward when line if not being answered\n"},
	...
	{"dndFeature",	 		D_OBJ_REF(dndFeature.enabled),		SCCP_CONFIG_DATATYPE_BOOLEAN,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		"yes",			NULL, 					"allow usage do not disturb button\n"},
	...
	{"deny", 			D_OBJ_REF(ha),	 			SCCP_CONFIG_DATATYPE_GENERIC,	SCCP_CONFIG_FLAG_GET_GLOBAL_DEFAULT | SCCP_CONFIG_FLAG_MULTI_ENTRY,	SCCP_CONFIG_NEEDDEVICERESET,		NULL,			sccp_config_parse_deny,			"Same as general\n"},
	{"permit", 			D_OBJ_REF(ha), 				SCCP_CONFIG_DATATYPE_GENERIC,	SCCP_CONFIG_FLAG_GET_GLOBAL_DEFAULT | SCCP_CONFIG_FLAG_MULTI_ENTRY,	SCCP_CONFIG_NEEDDEVICERESET,		NULL,			sccp_config_parse_permit,		"This device can register only using this ip address\n"},
	...
	{"useRedialMenu", 		D_OBJ_REF(useRedialMenu), 		SCCP_CONFIG_DATATYPE_BOOLEAN,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		"no",			NULL, 					"show the redial phone book list instead of dialing the last number (adv_feature)\n"},
#endif
#ifdef CS_SCCP_PICKUP
	{"pickupexten", 		D_OBJ_REF(pickupexten), 		SCCP_CONFIG_DATATYPE_BOOLEAN,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		"no",			NULL, 					"enable Pickup function to direct pickup an extension\n"},
	...
	{"pickupmodeanswer", 		D_OBJ_REF(pickupmodeanswer), 		SCCP_CONFIG_DATATYPE_BOOLEAN,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		"yes",			NULL, 					"on = asterisk way, the call has been answered when picked up\n"},
#endif
	...
	{"allowoverlap", 		D_OBJ_REF(overlapFeature.enabled), 	SCCP_CONFIG_DATATYPE_BOOLEAN,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		NULL,			NULL, 					"Allow for Overlap dialing (Continue dialing after the first part of the number has already been send to the pstn)"},
	{"setvar", 			D_OBJ_REF(variables),			SCCP_CONFIG_DATATYPE_GENERIC,	SCCP_CONFIG_FLAG_NONE | SCCP_CONFIG_FLAG_MULTI_ENTRY,		SCCP_CONFIG_NOUPDATENEEDED, 		NULL, 			sccp_config_parse_variables,		"extra variables to be set on line initialization multiple entries possible (for example the sip number to use when dialing outside)\n"
																																			"format setvar=param=value, for example setvar=sipno=12345678\n"},
	{"permithost", 			D_OBJ_REF(permithosts), 		SCCP_CONFIG_DATATYPE_GENERIC,	SCCP_CONFIG_FLAG_NONE | SCCP_CONFIG_FLAG_MULTI_ENTRY,		SCCP_CONFIG_NEEDDEVICERESET,		NULL,			sccp_config_parse_permithosts,		"permit/deny but by resolved hostname"},
	{"addon", 			D_OBJ_REF(addons),	 		SCCP_CONFIG_DATATYPE_GENERIC,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NEEDDEVICERESET,		NULL,			sccp_config_parse_addons,		"One of 7914, 7915, 7916"},
	{"button", 			D_OBJ_REF(buttonconfig), 		SCCP_CONFIG_DATATYPE_GENERIC,	SCCP_CONFIG_FLAG_NONE | SCCP_CONFIG_FLAG_MULTI_ENTRY,		SCCP_CONFIG_NEEDDEVICERESET,		NULL,			sccp_config_parse_button,		""},
...
static const SCCPConfigOption sccpLineConfigOptions[] = {
	...
	{"secondary_dialtone_digits", 	L_OBJ_REF(secondary_dialtone_digits),	SCCP_CONFIG_DATATYPE_GENERIC,	SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,	 	"", 			sccp_config_parse_secondaryDialtoneDigits,"digits to indicate an external line to user (secondary dialtone) (max 9 digits)\n"},
	...
	{"setvar", 			L_OBJ_REF(variables),			SCCP_CONFIG_DATATYPE_GENERIC,	SCCP_CONFIG_FLAG_NONE | SCCP_CONFIG_FLAG_MULTI_ENTRY,	 	SCCP_CONFIG_NOUPDATENEEDED, 		NULL, 			sccp_config_parse_variables,		"extra variables to be set on line initialization multiple entries possible (for example the sip number to use when dialing outside)\n"
																																			"format setvar=param=value, for example setvar=sipno=12345678\n"},
