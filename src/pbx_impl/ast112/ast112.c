...
static boolean_t sccp_wrapper_asterisk112_attended_transfer(sccp_channel_t * transferee, sccp_channel_t * transferer)
{
	int res = FALSE;
...
static boolean_t sccp_wrapper_asterisk112_blind_transfer(sccp_channel_t * transferee, const char *extension, const char *context)
{
	int res = FALSE;
