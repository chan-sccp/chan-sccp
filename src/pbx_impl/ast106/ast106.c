...
static boolean_t sccp_wrapper_asterisk106_attended_transfer(sccp_channel_t * transferee, sccp_channel_t * transferer)
{
	boolean_t res = FALSE;
...
static boolean_t sccp_wrapper_asterisk106_blind_transfer(sccp_channel_t * transferee, const char *extension, const char *context)
{
	boolean_t res = FALSE;
...
const PbxInterface iPbx = {
	...
	blind_transfer:			sccp_wrapper_asterisk106_blind_transfer,
