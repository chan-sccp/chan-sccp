...
unsigned int				echocancel:
        1;				/*!< echocancel phone support */
unsigned int				silencesuppression:
        1;			/*!< Silence Suppression Phone Support */
unsigned int				transfer:
        1;				/*!< Transfer Phone Support */
unsigned int				spareBit4:
        1;				/*!< SpareBit4 */
unsigned int				spareBit5:
        1;				/*!< SpareBit5 */
unsigned int				spareBit6:
        1;				/*!< SpareBit6 */
#ifdef CS_SCCP_REALTIME
boolean_t				realtime:
        1;				/*!< is it a realtimeconfiguration*/
#endif
...
unsigned int				pendingDelete:
        1;			/*!< this bit will tell the scheduler to delete this line when unused */
unsigned int				pendingUpdate:
        1;			/*!< this bit will tell the scheduler to update this line when unused */
#endif
...
#ifdef CS_DYNAMIC_CONFIG
unsigned int				pendingDelete:
        1;			/*!< this bit will tell the scheduler to delete this speed when unused */
unsigned int				pendingUpdate:
        1;			/*!< this bit will tell the scheduler to update this speed when unused */
#endif
...
unsigned int				mwilamp:
        3;				/*!< MWI/Lamp to indicate MailBox Messages */
unsigned int				mwioncall:
        1;				/*!< MWI On Call Support (Boolean, default=on) */
unsigned int				softkeysupport:
        1;			/*!< Soft Key Support (Boolean, default=on) */
unsigned int				mwilight:
        1;				/*!< MWI/Light Support (Boolean, default=on) \todo MWI/Light or Lamp was soll es sein */

unsigned int				transfer:
        1;				/*!< Transfer Support (Boolean, default=on) */
        //unsigned int				conference: 1;				/*!< Conference Support (Boolean, default=on) */
unsigned int				park:
        1;				/*!< Park Support (Boolean, default=on) */
unsigned int				cfwdall:
        1;				/*!< Call Forward All Support (Boolean, default=on) */
unsigned int				cfwdbusy:
        1;				/*!< Call Forward on Busy Support (Boolean, default=on) */
unsigned int				cfwdnoanswer:
        1;			/*!< Call Forward on No-Answer Support (Boolean, default=on) */

#ifdef CS_SCCP_PICKUP
unsigned int				pickupexten:
        1;				/*!< Pickup Extension Support (Boolean, default=on) */
        char					* pickupcontext;			/*!< Pickup Context to Use in DialPlan */
unsigned int				pickupmodeanswer:
        1;			/*!< Pickup Mode Answer */
#endif
unsigned int				dtmfmode:
        1; 				/*!< DTMF Mode (0 inband - 1 outofband) */
unsigned int				nat:
        1;					/*!< Network Address Translation Support (Boolean, default=on) */
unsigned int				directrtp:
        1;				/*!< Direct RTP Support (Boolean, default=on) */
unsigned int				trustphoneip:
        1;			/*!< Trust Phone IP Support (Boolean, default=on) */
unsigned int				needcheckringback:
        1;			/*!< Need to Check Ring Back Support (Boolean, default=on) */
...
unsigned int				pendingDelete:
        1;			/*!< this bit will tell the scheduler to delete this line when unused */
unsigned int				pendingUpdate:
        1;			/*!< this will contain the updated line struct once reloaded from config to update the line when unused */
...
unsigned int				needcheckringback:
        1;			/*!< Need Check Ring Back. (0/1) default 1 */
...
int					pickupmodeanswer:
        1;			/*!< Pick Up Mode Answer */
#endif
...
unsigned int				recorddigittimeoutchar:
        1; 		/*< Record Digit Time Out Char. Whether to include the digittimeoutchar in the call logs */
...
unsigned int				mwilamp:
        3;				/*!< MWI/Lamp (Default:3) */
unsigned int				mwioncall:
        1;				/*!< MWI On Call Support (Boolean, default=on) */
unsigned int				echocancel:
        1;				/*!< Echo Canel Support (Boolean, default=on) */
unsigned int				silencesuppression:
        1;			/*!< Silence Suppression Support (Boolean, default=on)  */
unsigned int				trustphoneip:
        1;				/*!< Trust Phone IP Support (Boolean, default=on) */
//	unsigned int				private: 1; 				/*!< Permit Private Function Support (Boolean, default=on) */
unsigned int				privacy:
        2;				/*!< Privacy Support (Default=2) */
unsigned int				blindtransferindication:
        1; 		/*!< Blind Transfer Indication Support (Boolean, default=on) */
unsigned int				cfwdall:
        1;				/*!< Call Forward All Support (Boolean, default=on) */
unsigned int				cfwdbusy:
        1;				/*!< Call Forward on Busy Support (Boolean, default=on) */
...
unsigned int				directrtp:
        1;				/*!< Direct RTP */
unsigned int				useoverlap:
        1;				/*!< Overlap Dial Support */
