...
static const SCCPConfigOption sccpGlobalConfigOptions[]={
	...
	{"externip", 			G_OBJ_REF(externip), 			TYPE_PARSER(sccp_config_parse_ipaddress),					SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NEEDDEVICERESET,		"0.0.0.0",			"IP Address that we're going to notify in RTP media stream\n"},
