...
static const SCCPConfigOption sccpSoftKeyConfigOptions[] = {
	...
	{"connconf",			S_OBJ_REF(modes[KEYMODE_CONNCONF]), 	TYPE_STRING,									SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		"conflist,newcall,join,endcall,hold,vidmode",						"displayed when we are in a conference"},
