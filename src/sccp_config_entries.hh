...
static const SCCPConfigOption sccpSoftKeyConfigOptions[] = {
	...
	{"offhookfeat",			S_OBJ_REF(modes[KEYMODE_OFFHOOKFEAT]), 	TYPE_STRING,									SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		"resume,newcall,transfer,endcall,private",							"displayed wenn we went offhook using a feature"},
