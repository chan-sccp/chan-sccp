...
static const SCCPConfigOption sccpSoftKeyConfigOptions[] = {
	...
	{"onstealable",			S_OBJ_REF(modes[KEYMODE_ONHOOKSTEALABLE]),TYPE_STRING,									SCCP_CONFIG_FLAG_NONE,						SCCP_CONFIG_NOUPDATENEEDED,		"redial, newcall, barge, intrcpt, cfwdall, pickup, gpickup, dnd",			"displayed when there is a call we could steal on one of the neighboring phones"},
