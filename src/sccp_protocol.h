...
static const struct cfsccp_messagetypes {
        ...
        { KeepAliveMessage				, 0x0000, "Keep Alive Message"				, "KeepAliveMessage" },
	{ RegisterMessage				, 0x0001, "Register Message"				, "RegisterMessage" },
	{ IpPortMessage					, 0x0002, "Ip-Port Message"				, "IpPortMessage " },
	{ KeypadButtonMessage				, 0x0003, "Keypad Button Message"			, "KeypadButtonMessage" },
	{ EnblocCallMessage				, 0x0004, "Enbloc Call Message"				, "EnblocCallMessage " },
	{ StimulusMessage				, 0x0005, "Stimulus Message"				, "StimulusMessage" },
	{ OffHookMessage				, 0x0006, "Off-Hook Message"				, "OffHookMessage" },
	{ OnHookMessage					, 0x0007, "On-Hook Message"				, "OnHookMessage " },
	{ HookFlashMessage				, 0x0008, "Hook-Flash Message"				, "HookFlashMessage" },
	{ ForwardStatReqMessage				, 0x0009, "Forward Statistics Request"			, "ForwardStatReqMessage " },
	{ SpeedDialStatReqMessage			, 0x000A, "Speed-Dial Statistics Request"		, "SpeedDialStatRequest" },
	{ LineStatReqMessage				, 0x000B, "Line Statistics Request"			, "LineStatRequest" },
	{ ConfigStatReqMessage				, 0x000C, "Config Statistics Request"			, "ConfigStatRequest" },
	{ TimeDateReqMessage				, 0x000D, "Time Date Request"				, "TimeDateRequest" },
	{ ButtonTemplateReqMessage			, 0x000E, "Button Template Request"			, "ButtonTemplateRequest" },
	{ VersionReqMessage				, 0x000F, "Version Request"				, "VersionReqMessage " },
	{ CapabilitiesResMessage			, 0x0010, "Capabilities Resquest Message"		, "CapabilitiesResMessage" },
	{ MediaPortListMessage				, 0x0011, "Media Port List Message"			, "MediaPortListMessage" },
	{ ServerReqMessage				, 0x0012, "Server Request"				, "ServerRequest" },
	{ AlarmMessage					, 0x0020, "Alarm Message"				, "AlarmMessage" },
	{ MulticastMediaReceptionAck			, 0x0021, "Multicast Media Reception Acknowledge"	, "MulticastMediaReceptionAck" },
	{ OpenReceiveChannelAck				, 0x0022, "Open Receive Channel Acknowledge"		, "OpenReceiveChannelAck " },
	{ ConnectionStatisticsRes			, 0x0023, "Connection Statistics Response"		, "ConnectionStatisticsRes" },
	{ OffHookWithCgpnMessage			, 0x0024, "Off-Hook With Cgpn Message"			, "OffHookWithCgpnMessage" },
	{ SoftKeySetReqMessage				, 0x0025, "SoftKey Set Request"				, "SoftKeySetRequest" },
	{ SoftKeyEventMessage				, 0x0026, "SoftKey Event Message"			, "SoftKeyEventMessage" },
	{ UnregisterMessage				, 0x0027, "Unregister Message"				, "UnregisterMessage " },
	{ SoftKeyTemplateReqMessage			, 0x0028, "SoftKey Template Request"			, "SoftKeyTemplateReqMessage " },
	{ RegisterTokenReq				, 0x0029, "Register Token Request"			, "RegisterTokenReq" },
	{ HeadsetStatusMessage				, 0x002B, "Headset Status Message"			, "HeadsetStatusMessage" },
	{ MediaResourceNotification			, 0x002C, "Media Resource Notification"			, "MediaResourceNotification " },
	{ RegisterAvailableLinesMessage			, 0x002D, "Register Available Lines Message"		, "RegisterAvailableLinesMessage " },
	{ DeviceToUserDataMessage			, 0x002E, "Device To User Data Message"			, "DeviceToUserDataMessage" },
	{ DeviceToUserDataResponseMessage		, 0x002F, "Device To User Data Response"		, "DeviceToUserDataResponseMessage" },
	{ UpdateCapabilitiesMessage			, 0x0030, "Update Capabilities Message"			, "UpdateCapabilitiesMessage " },
	{ OpenMultiMediaReceiveChannelAckMessage	, 0x0031, "Open MultiMedia Receive Channel Acknowledge"	, "OpenMultiMediaReceiveChannelAckMessage" },
	{ ClearConferenceMessage			, 0x0032, "Clear Conference Message"			, "ClearConferenceMessage" },
	{ ServiceURLStatReqMessage			, 0x0033, "Service URL Statistics Request"		, "ServiceURLStatRequest" },
	{ FeatureStatReqMessage				, 0x0034, "Feature Statistics Request"			, "FeatureStatReqMessage " },
	{ CreateConferenceResMessage			, 0x0035, "Create Conference Response"			, "CreateConferenceResMessage" },
	{ DeleteConferenceResMessage			, 0x0036, "Delete Conference Response"			, "DeleteConferenceResMessage" },
	{ ModifyConferenceResMessage			, 0x0037, "Modify Conference Response"			, "ModifyConferenceResMessage" },
	{ AddParticipantResMessage			, 0x0038, "Add Participant Response"			, "AddParticipantResMessage" },
	{ AuditConferenceResMessage			, 0x0039, "Audit Conference Response"			, "AuditConferenceResMessage " },
	{ AuditParticipantResMessage			, 0x0040, "Audit Participant Response"			, "AuditParticipantResMessage" },
	{ DeviceToUserDataVersion1Message		, 0x0041, "Device To User Data Version1 Message"	, "DeviceToUserDataVersion1Message" },
	{ DeviceToUserDataResponseVersion1Message	, 0x0042, "Device To User Data Version1 Response"	, "DeviceToUserDataResponseVersion1Message" },
	{ DialedPhoneBookMessage			, 0x0048, "Dialed PhoneBook Message"			, "DialedPhoneBookMessage" },
	{ AccessoryStatusMessage			, 0x0049, "Accessory Status Message"			, "AccessoryStatusMessage" },
	{ Unknown_0x004A_Message			, 0x004A, "Unknown_0x004A_Message"			, "Unknown_0x004A_Message" },
	{ RegisterAckMessage				, 0x0081, "Register Acknowledge"			, "RegisterAckMessage" },
	{ StartToneMessage				, 0x0082, "Start Tone Message"				, "StartToneMessage" },
	{ StopToneMessage				, 0x0083, "Stop Tone Message"				, "StopToneMessage" },
	{ SetRingerMessage				, 0x0085, "Set Ringer Message"				, "SetRingerMessage" },
	{ SetLampMessage				, 0x0086, "Set Lamp Message"				, "SetLampMessage" },
	{ SetHkFDetectMessage				, 0x0087, "Set HkF Detect Message"			, "SetHkFDetectMessage" },
	{ SetSpeakerModeMessage				, 0x0088, "Set Speaker Mode Message"			, "SetSpeakerModeMessage " },
	{ SetMicroModeMessage				, 0x0089, "Set Micro Mode Message"			, "SetMicroModeMessage" },
	{ StartMediaTransmission			, 0x008A, "Start Media Transmission"			, "StartMediaTransmission" },
	{ StopMediaTransmission				, 0x008B, "Stop Media Transmission"			, "StopMediaTransmission " },
	{ StartMediaReception				, 0x008C, "Start Media Reception"			, "StartMediaReception" },
	{ StopMediaReception				, 0x008D, "Stop Media Reception"			, "StopMediaReception" },
	{ CallInfoMessage				, 0x008F, "Call Information Message"			, "CallInfoMessage" },
	{ ForwardStatMessage				, 0x0090, "Forward Staticstics Message"			, "ForwardStatMessage" },
	{ SpeedDialStatMessage				, 0x0091, "SpeedDial Staticstics Message"		, "SpeedDialStatMessage" },
	{ LineStatMessage				, 0x0092, "Line Staticstics Message"			, "LineStatMessage" },
	{ ConfigStatMessage				, 0x0093, "Config Staticstics Message"			, "ConfigStatMessage " },
	{ DefineTimeDate				, 0x0094, "Define Time Date"				, "DefineTimeDate" },
	{ StartSessionTransmission			, 0x0095, "Start Session Transmission"			, "StartSessionTransmission" },
	{ StopSessionTransmission			, 0x0096, "Stop Session Transmission"			, "StopSessionTransmission" },
	{ ButtonTemplateMessage				, 0x0097, "Button Template Message"			, "ButtonTemplateMessage " },
	{ ButtonTemplateMessageSingle			, 0x0097, "Button Template Message Single"		, "ButtonTemplateMessageSingle" },
	{ VersionMessage				, 0x0098, "Version Message"				, "VersionMessage" },
	{ DisplayTextMessage				, 0x0099, "Display Text Message"			, "DisplayTextMessage" },
	{ ClearDisplay					, 0x009A, "Clear Display"				, "ClearDisplay" },
	{ CapabilitiesReqMessage			, 0x009B, "Capabilities Request"			, "CapabilitiesRequest" },
	{ EnunciatorCommandMessage			, 0x009C, "Enunciator Command Message"			, "EnunciatorCommandMessage" },
	{ RegisterRejectMessage				, 0x009D, "Register Reject Message"			, "RegisterRejectMessage " },
	{ ServerResMessage				, 0x009E, "Server Response"				, "ServerResponse" },
	{ Reset						, 0x009F, "Reset"					, "Reset " },
	{ KeepAliveAckMessage				, 0x0100, "Keep Alive Acknowledge"			, "KeepAliveAckMessage" },
	{ StartMulticastMediaReception			, 0x0101, "Start MulticastMedia Reception"		, "StartMulticastMediaReception" },
	{ StartMulticastMediaTransmission		, 0x0102, "Start MulticastMedia Transmission"		, "StartMulticastMediaTransmission" },
	{ StopMulticastMediaReception			, 0x0103, "Stop MulticastMedia Reception"		, "StopMulticastMediaReception" },
	{ StopMulticastMediaTransmission		, 0x0104, "Stop MulticastMedia Transmission"		, "StopMulticastMediaTransmission" },
	{ OpenReceiveChannel				, 0x0105, "Open Receive Channel"			, "OpenReceiveChannel" },
	{ CloseReceiveChannel				, 0x0106, "Close Receive Channel"			, "CloseReceiveChannel" },
	{ ConnectionStatisticsReq			, 0x0107, "Connection Statistics Request"		, "ConnectionStatisticsReq" },
	{ SoftKeyTemplateResMessage			, 0x0108, "SoftKey Template Response"			, "SoftKeyTemplateResMessage " },
	{ SoftKeySetResMessage				, 0x0109, "SoftKey Set Response"			, "SoftKeySetResponse" },
	{ SelectSoftKeysMessage				, 0x0110, "Select SoftKeys Message"			, "SelectSoftKeysMessage " },
	{ CallStateMessage				, 0x0111, "Call State Message"				, "CallStateMessage" },
	{ DisplayPromptStatusMessage			, 0x0112, "Display Prompt Status Message"		, "DisplayPromptStatusMessage" },
	{ ClearPromptStatusMessage			, 0x0113, "Clear Prompt Status Message"			, "ClearPromptStatusMessage" },
	{ DisplayNotifyMessage				, 0x0114, "Display Notify Message"			, "DisplayNotifyMessage" },
	{ ClearNotifyMessage				, 0x0115, "Clear Notify Message"			, "ClearNotifyMessage" },
	{ ActivateCallPlaneMessage			, 0x0116, "Activate Call Plane Message"			, "ActivateCallPlaneMessage" },
	{ DeactivateCallPlaneMessage			, 0x0117, "Deactivate Call Plane Message"		, "DeactivateCallPlaneMessage" },
	{ UnregisterAckMessage				, 0x0118, "Unregister Acknowledge"			, "UnregisterAckMessage" },
	{ BackSpaceReqMessage				, 0x0119, "Back Space Request"				, "BackSpaceRequest" },
	{ RegisterTokenAck				, 0x011A, "Register Token Acknowledge"			, "RegisterTokenAck" },
	{ RegisterTokenReject				, 0x011B, "Register Token Reject"			, "RegisterTokenReject" },
	{ StartMediaFailureDetection			, 0x011C, "Start Media Failure Detection"		, "StartMediaFailureDetection" },
	{ DialedNumberMessage				, 0x011D, "Dialed Number Message"			, "DialedNumberMessage" },
	{ UserToDeviceDataMessage			, 0x011E, "User To Device Data Message"			, "UserToDeviceDataMessage" },
	{ FeatureStatMessage				, 0x011F, "Feature Staticstics Message"			, "FeatureStaticstics Message" },
	{ DisplayPriNotifyMessage			, 0x0120, "Display Pri Notify Message"			, "DisplayPriNotifyMessage" },
	{ ClearPriNotifyMessage				, 0x0121, "Clear Pri Notify Message"			, "ClearPriNotifyMessage " },
	{ StartAnnouncementMessage			, 0x0122, "Start Announcement Message"			, "StartAnnouncementMessage" },
	{ StopAnnouncementMessage			, 0x0123, "Stop Announcement Message"			, "StopAnnouncementMessage" },
	{ AnnouncementFinishMessage			, 0x0124, "Announcement Finish Message"			, "AnnouncementFinishMessage " },
	{ NotifyDtmfToneMessage				, 0x0127, "Notify DTMF Tone Message"			, "NotifyDtmfToneMessage " },
	{ SendDtmfToneMessage				, 0x0128, "Send DTMF Tone Message"			, "SendDtmfToneMessage" },
	{ SubscribeDtmfPayloadReqMessage		, 0x0129, "Subscribe DTMF Payload Request"		, "SubscribeDtmfPayloadRequest" },
	{ SubscribeDtmfPayloadResMessage		, 0x012A, "Subscribe DTMF Payload Response"		, "SubscribeDtmfPayloadResponse" },
	{ SubscribeDtmfPayloadErrMessage		, 0x012B, "Subscribe DTMF Payload Error Message"	, "SubscribeDtmfPayloadErrMessage" },
	{ UnSubscribeDtmfPayloadReqMessage		, 0x012C, "UnSubscribe DTMF Payload Request"		, "UnSubscribeDtmfPayloadRequest" },
	{ UnSubscribeDtmfPayloadResMessage		, 0x012D, "UnSubscribe DTMF Payload Response"		, "UnSubscribeDtmfPayloadResponse" },
	{ UnSubscribeDtmfPayloadErrMessage		, 0x012E, "UnSubscribe DTMF Payload Error Message"	, "UnSubscribeDtmfPayloadErrMessage" },
	{ ServiceURLStatMessage				, 0x012F, "ServiceURL Staticstics Message"		, "ServiceURLStatMessage " },
	{ CallSelectStatMessage				, 0x0130, "Call Select Staticstics Message"		, "CallSelectStatMessage " },
	{ OpenMultiMediaChannelMessage			, 0x0131, "Open MultiMedia Channel Message"		, "OpenMultiMediaChannelMessage" },
	{ StartMultiMediaTransmission			, 0x0132, "Start MultiMedia Transmission"		, "StartMultiMediaTransmission" },
	{ StopMultiMediaTransmission			, 0x0133, "Stop MultiMedia Transmission"		, "StopMultiMediaTransmission" },
	{ MiscellaneousCommandMessage			, 0x0134, "Miscellaneous Command Message"		, "MiscellaneousCommandMessage" },
	{ FlowControlCommandMessage			, 0x0135, "Flow Control Command Message"		, "FlowControlCommandMessage " },
	{ CloseMultiMediaReceiveChannel			, 0x0136, "Close MultiMedia Receive Channel"		, "CloseMultiMediaReceiveChannel " },
	{ CreateConferenceReqMessage			, 0x0137, "Create Conference Request"			, "CreateConferenceRequest" },
	{ DeleteConferenceReqMessage			, 0x0138, "Delete Conference Request"			, "DeleteConferenceRequest" },
	{ ModifyConferenceReqMessage			, 0x0139, "Modify Conference Request"			, "ModifyConferenceRequest" },
	{ AddParticipantReqMessage			, 0x013A, "Add Participant Request"			, "AddParticipantRequest" },
	{ DropParticipantReqMessage			, 0x013B, "Drop Participant Request"			, "DropParticipantReqMessage " },
	{ AuditConferenceReqMessage			, 0x013C, "Audit Conference Request"			, "AuditConferenceReqMessage " },
	{ AuditParticipantReqMessage			, 0x013D, "Audit Participant Request"			, "AuditParticipantRequest" },
	{ UserToDeviceDataVersion1Message		, 0x013F, "User To Device Data Version1 Message"	, "UserToDeviceDataVersion1Message" },
	{ Unknown_0x0143_Message			, 0x0143, "Unknown 0x0143_Message"			, "Unknown_0x0143_Message" },
	{ Unknown_0x0144_Message			, 0x0144, "Unknown 0x0144_Message"			, "Unknown_0x0144_Message" },
	{ DisplayDynamicPromptStatusMessage		, 0x0145, "Display Dynamic Prompt Status Message"	, "DisplayDynamicPromptStatusMessage" },
	{ SpeedDialStatDynamicMessage			, 0x0146, "SpeedDial Statistics Dynamic Message"	, "SpeedDialStatDynamicMessage" },
	{ LineStatDynamicMessage			, 0x0147, "Line Statistics Dynamic Message"		, "LineStatDynamicMessage" },
	{ Unknown_0x0149_Message			, 0x0149, "Unknown 0x0149 Message"			, "Unknown_0x0149_Message" },
	{ CallInfoDynamicMessage			, 0x014A, "Call Information Dynamic Message"		, "CallInfoDynamicMessage" },
	{ StartMediaTransmissionAck			, 0x0154, "Start Media Transmission Acknowledge"	, "StartMediaTransmissionAck" },
        { Unknown_0x0159_Message			, 0x0159, "Unknown 0x0159 Message"			, "Unknown_0x0159_Message"},
};
