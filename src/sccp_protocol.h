...
typedef struct {
	...
	union {
		...
		struct {
			uint32_t lel_capabilityBitfield;
			uint32_t lel_annexNandWFutureUse;
		} h263;
		struct {
			uint32_t profile;									/*!< H264 profile */
			uint32_t level;										/*!< H264 level */
			uint32_t customMaxMBPS;
			uint32_t customMaxFS;
			uint32_t customMaxDPB;
			uint32_t customMaxBRandCPB;
		} h264;
		struct {
...
typedef union {
	...
	struct {
		...
		videoCap_t videoCaps[SKINNY_MAX_VIDEO_CAPABILITIES];						/*!< Video Capabilities V2 */
	...
	struct {
		...
		audioCap_t audioCaps[SKINNY_MAX_CAPABILITIES];							/*!< Audio Capabilities */
		videoCap_t videoCaps[SKINNY_MAX_VIDEO_CAPABILITIES];						/*!< Video Capabilities V3 */
		dataCap_t dataCaps[SKINNY_MAX_DATA_CAPABILITIES];						/*!< Data Capabilities */
