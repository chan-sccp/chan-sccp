...
/*!
 * \brief SCCP Get Empty Config Structure
 */
 ...
 * \param device SCCP Device
 * \param label Label as char
 * \param featureID Feature ID as char
 * \param args Feature Argements as char
 * \param index Index Preferred Button Position as int
 */
 ...
 * \param deviceName SCCP Device (name of device e.g. SEP0123455689)
 * \param isRealtime Configuration is generated by realtime as boolean
