...
/* *INDENT-OFF* */
  ...
  {"disallow", 				D_OBJ_REF(config_preferences), 		SCCP_CONFIG_DATATYPE_GENERIC,	SCCP_CONFIG_FLAG_GET_GLOBAL_DEFAULT,	SCCP_CONFIG_NOUPDATENEEDED,		NULL,	sccp_config_parse_disallow_codec,""},
  {"allow", 				D_OBJ_REF(config_preferences), 		SCCP_CONFIG_DATATYPE_GENERIC,	SCCP_CONFIG_FLAG_GET_GLOBAL_DEFAULT,	SCCP_CONFIG_NOUPDATENEEDED,		NULL,	sccp_config_parse_allow_codec,""},
  ...
  {"dndFeature",	 		D_OBJ_REF(dndFeature.enabled),		SCCP_CONFIG_DATATYPE_BOOLEAN,	SCCP_CONFIG_FLAG_NONE,			SCCP_CONFIG_NOUPDATENEEDED,		"off",	NULL, 				"allow usage do not disturb button"},
