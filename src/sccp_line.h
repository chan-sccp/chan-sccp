...
#define sccp_linedevice_refreplace(x, y) sccp_refcount_replace(x, y, __FILE__, __LINE__, __PRETTY_FUNCTION__)
...
#define sccp_line_refreplace(x, y)	sccp_refcount_replace(x, y, __FILE__, __LINE__, __PRETTY_FUNCTION__)
