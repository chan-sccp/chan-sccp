...
SCCP_API void SCCP_CALL __sccp_indicate(constLineDevicePtr maybe_ld, channelPtr c, const sccp_channelstate_t state, const uint8_t debug, const char *file, const int line, const char *pretty_function);
